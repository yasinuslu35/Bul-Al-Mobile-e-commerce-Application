...
import '../../ViewModel/urunOzellikleriViewModel.dart';
...
class _LedState extends State<Led> {
  ...
  Widget build(BuildContext context) {
    ...
    final _ledviewModel = Provider.of<LedViewModel>(context);
